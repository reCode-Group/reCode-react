      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 justify-between gap-12 py-8 sm:grid-rows-[auto_auto] md:grid-cols-4 md:grid-rows-[auto_auto] md:py-12 lg:grid-cols-[repeat(4,minmax(0,140px))_1fr] lg:grid-rows-1 xl:gap-20">
          <div className="space-y-2">
            <h3 className="theme-heading text-sm font-medium">Product</h3>
          ...
          <div className="space-y-2">
            <h3 className="theme-heading text-sm font-medium">Company</h3>
            <ul className="space-y-2 text-sm">
              {[
                "About us",
                "Diversity & Inclusion",
          ...
          <div className="space-y-2">
            <h3 className="theme-heading text-sm font-medium">Resources</h3>
            <ul className="space-y-2 text-sm">
          ...
          <div className="space-y-2">
            <h3 className="theme-heading text-sm font-medium">Content Library</h3>
            <ul className="space-y-2 text-sm">
              {[
                "Templates",
                "Tutorials",
