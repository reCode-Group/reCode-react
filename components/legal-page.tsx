        ...
        <div className="py-12 md:py-20">
          <div className="testimonial-card mb-8 rounded-[28px] px-5 py-8 sm:px-8 md:px-10 md:py-10">
            ...
            <p className="theme-muted mt-5 max-w-3xl text-base leading-7 md:text-lg">
              Реквизиты ООО «РЕКОД РЕШЕНИЯ», публичная оферта, пользовательское соглашение, документы об обработке персональных данных, правила работы с пользовательским кодом, оплаты и возвратов.
            </p>
          </div>
